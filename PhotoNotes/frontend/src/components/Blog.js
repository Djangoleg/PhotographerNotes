    ...
    PhotoNotesItem = ({note, startId}) => {
        ...
        return (
            <div className="row no-gutters-lg">
                        ...
                        <div className="col-12 mb-4">
                            <article className="card article-card">
                                ...
                                <div className="d-flex justify-content-between">
                                    {isAuthenticated ? <this.DeleteButton note={note}/> : null}
                                    {isAuthenticated ? <this.EditButton noteId={note.id}/> : null}
                                </div>
                            </article>
                        </div>
                    </div>
                ...
                {(note.id === startId) ? <this.Categories/> : null}
            </div>
        );
    }
                ...
                <main>
                    <section className="section">
                        <div className="container">
                            {this.state.notes.map((note) => <this.PhotoNotesItem key={note.id} note={note}
